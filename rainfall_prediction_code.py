...
print(predicted_LR1, predicted_LR2)
...
print(predicted_lasso1, predicted_lasso2)
...
print(predicted_ridge1, predicted_ridge2)

# 4.SVM_Regression - Model
...
print(predicted_rf1, predicted_rf2)
